...
const getLineOptions = (ctx, fill) => {
    ...
    gradientStroke.addColorStop(0, root.getPropertyValue('--color-7'));
    gradientStroke.addColorStop(0.3, root.getPropertyValue('--color-7'));
    gradientStroke.addColorStop(0.6, root.getPropertyValue('--color-7'));
    gradientStroke.addColorStop(1, root.getPropertyValue('--color-7'));
    
    const gradientFill = ctx.createLinearGradient(0, 0, 1200, 0);
    gradientFill.addColorStop(0, root.getPropertyValue('--color-7-opacity'));
    gradientFill.addColorStop(0.3, root.getPropertyValue('--color-7-opacity'));
    gradientFill.addColorStop(0.6, root.getPropertyValue('--color-7-opacity'));
    gradientFill.addColorStop(1, root.getPropertyValue('--color-7-opacity'));
